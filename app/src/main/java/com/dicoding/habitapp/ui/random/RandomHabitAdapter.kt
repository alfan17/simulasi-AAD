...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            when(pageType) {
                PageType.HIGH -> pagerPriorityLevel.setImageResource(R.drawable.ic_priority_high)
                PageType.MEDIUM -> pagerPriorityLevel.setImageResource(R.drawable.ic_priority_medium)
                else -> pagerPriorityLevel.setImageResource(R.drawable.ic_priority_low)
            }
